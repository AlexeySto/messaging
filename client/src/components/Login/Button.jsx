...
const Button = ({ label }) => {
    return (
        <button className="form__button_registration" >{label}<svg width="17.000977" height="9.918610" viewBox="0 0 17.001 9.91861" fill="none" xmlns="http://www.w3.org/2000/svg">
